...
$(document).ready(function(){
	$("#searchp").on("submit",function(e){
		...
		$.get("./?action=bombsearchproduct",$("#searchp").serialize(),function(data){
...
<tr >
	...
	<td style="width:30px;"><a href="index.php?view=bombclearcart&product_id=<?php echo $product->id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>

<?php endforeach; ?>
</table>
<form method="post" class="form-horizontal" id="processsell" action="index.php?view=bombprocesssell">
<h2>Resumen</h2>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
		<a href="index.php?view=bombclearcart" class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
