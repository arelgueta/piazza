...
<div class="row">
	<div class="col-md-12">
	<a href="index.php?view=bombreportsbyproduct" class="pull-right btn btn-lg btn-default	"> <i class="glyphicon glyphicon-chevron-left"></i> Regresar  </a>
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
			<?php $operations = BombOperationData::getAllByDateOfficialBP($_GET["id"], $_GET["sd"],$_GET["ed"]);
			 ?>
