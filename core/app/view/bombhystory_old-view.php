...
$operations = BombOperationData::getAllByProductIdCutId($product->id,$cut->id);
?>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-4">
	<?php
$total = BombOperationData::GetQ($product->id,$cut->id);
$no_oficial = BombOperationData::GetQNoF($product->id,$cut->id);
$oficial = BombOperationData::GetQYesF($product->id,$cut->id);
...
?>
	...
	<?php
$itotal = BombOperationData::GetInputQ($product->id,$cut->id);
$ino_oficial = BombOperationData::GetInputQNoF($product->id,$cut->id);
$ioficial = BombOperationData::GetInputQYesF($product->id,$cut->id);
...
?>
	...
	<?php
$ototal = -1*BombOperationData::GetOutputQ($product->id,$cut->id);
$ono_oficial = -1*BombOperationData::GetOutputQNoF($product->id,$cut->id);
$ooficial = -1*BombOperationData::GetOutputQYesF($product->id,$cut->id);
