...
?>			
		...
		<td style="width:30px;"><a href="index.php?view=bombdelre&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
	</tr>
