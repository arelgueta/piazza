...
<?php
$products = BombSellData::getByBoxId($_GET["id"]);
if(count($products)>0){
$total_total = 0;
?>
<br>
<table class="table table-bordered table-hover	">
	...
	<tr>
		<td style="width:30px;">
<a href="./index.php?view=bombonesell&id=<?php echo $sell->id; ?>" class="btn btn-default btn-xs"><i class="fa fa-arrow-right"></i></a>			
