...
<div class="row">
	...
	<?php
$itotal = BombOperationData::GetInputQYesF($product->id);
...
?>
	...
	<div class="col-md-4">
	<?php
$total = BombOperationData::GetQYesF($product->id);
...
?>
	...
	<?php
$ototal = -1*BombOperationData::GetOutputQYesF($product->id);
	...
	<div class="col-md-12">
		<?php if(count($operations)>0):?>
			...
			$("#oper-"+<?php echo $operation->id; ?>).click(function(){
				...
				if(x==true){
					window.location = "index.php?view=bombdeleteoperation&ref=history&pid=<?php echo $operation->product_id;?>&opid=<?php echo $operation->id;?>";
				}
			});
