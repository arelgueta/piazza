...
<?php if(isset($_GET["product"])):?>
	<?php
$products = BombProductData::getLike($_GET["product"]);
if(count($products)>0){
	?>
...
$product = BombProductData::getById($error["product_id"]);
?>
<tr class="danger">
...
$product = BombProductData::getById($p["product_id"]);
?>
<tr >
	<td><?php echo $product->id; ?></td>
	<td ><?php echo $p["q"]; ?></td>
	...
	<td style="width:30px;"><a href="index.php?view=bombclearre&product_id=<?php echo $product->id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>

<?php endforeach; ?>
</table>
<form method="post" class="form-horizontal" id="processsell" action="index.php?view=bombprocessre">
<h2>Resumen</h2>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
		<a href="index.php?view=bombclearre" class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
