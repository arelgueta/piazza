...
<div class="row">
	...
	<h1>Reportes de Ventas</h1>
						...
						<form>
						<input type="hidden" name="view" value="bombsellreports">
<div class="row">
<div class="col-md-3">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
			...
			if($_GET["client_id"]==""){
			$operations = BombSellData::getAllByDateOp($_GET["sd"],$_GET["ed"],2);
			}
			else{
			$operations = BombSellData::getAllByDateBCOp($_GET["client_id"],$_GET["sd"],$_GET["ed"],2);
			} 
