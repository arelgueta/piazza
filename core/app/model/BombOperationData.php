<?php
class BombOperationData {
	public static $tablename = "operationbomb";

	public function BombOperationData(){
		$this->name = "";
		$this->product_id = "";
		$this->q = "";
		$this->cut_id = "";
...
// partiendo de que ya tenemos creado un objecto BombOperationData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new BombOperationData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new BombOperationData());
